...
public class CatzConstants {
     ...
     */
    public static final Translation2d SWERVE_LEFT_FRONT_LOCATION = new Translation2d(0.4572, 0.4572);
    public static final Translation2d SWERVE_LEFT_BACK_LOCATION = new Translation2d(0.4572, -0.4572);
    public static final Translation2d SWERVE_RIGHT_FRONT_LOCATION = new Translation2d(-0.4572, 0.4572);
    public static final Translation2d SWERVE_RIGHT_BACK_LOCATION = new Translation2d(-0.4572, -0.4572);
